...
Econometrics is the application of statistical methods to economic data, with the goal of giving empirical content to economic relationships [@wooldridge2020; @cgl2017]. Its main objective is the **estimation of relationships between variables**. Typical pairs of interest in this course include:
